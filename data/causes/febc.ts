...
export const febc: Cause = {
  ...
  notVerified: [
    ...
    'Whether the affiliate-support line can be divided by the 19 offices. It is the one place in these documents where a spending figure and a count of something FEBC itself delivered sit in the same sentence — Part III 4c reports $2,074,052 of expenses and reads “THE U.S. OFFICE PROVIDES LEADERSHIP, CONSULTING SERVICES AND TRAINING TO 19 AFFILIATE OFFICES, INCLUDING STUDIOS, OFFICE SPACE, COMMUNICATION SERVICES AND IT SUPPORT.” We checked it and rejected it, because the same line continues “THE U.S. OFFICE ALSO ADMINISTERS PLANNED GIVING PROGRAMS INCLUDING CHARITABLE GIFT ANNUITIES, CHARITABLE TRUSTS, WILLS AND BEQUESTS, ETC.” Fundraising administration is inside that $2,074,052 and nothing anywhere says how much, so a cost per affiliate office would have a donor-acquisition cost buried in it.',
    'Whether FEBC publishes an annual or impact report containing a year’s delivered counts. It does not. We tried ten paths on febc.org — /annual-report/, /annual-reports/, /about/annual-report/, /about/annual-reports/, /impact-report/, /reports/, /financials/, /about/financials/, /accountability/ and /stewardship/ — and every one returned 404. The only accountability page that exists is /about/financial-accountability/, which holds two seals, two percentages and links to the audit and the Form 990. Between them those two documents count stations, languages, transmitters, daily hours and dollars, and not one listener response, letter, call, message or broadcast hour actually aired.',
