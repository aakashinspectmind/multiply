...
export const serge: Cause = {
    ...
    alternates: [
      {
        ...
        count: 325,
        note: "$75,269.74. The Where We Serve page says over 325, so this is the same arithmetic against Serge's public figure rather than its audited footnote.",
      },
      {
        label: 'missionaries, against every dollar Serge spent',
        count: 330,
        note: 'Dividing total expenses of $30,344,283 rather than field operations gives $91,952.37 per missionary-year. That is the fully loaded cost including the home office and fundraising, and it is the number a donor should have in mind when comparing a sent worker to anything else in this directory.',
      },
      {
        label: 'employees, agents and independent contractors reported in Schedule F',
        count: 210,
        note: "Serge's Form 990 reports 110 people in Europe, 58 in Sub-Saharan Africa, 26 in South Asia, 11 in Central America and the Caribbean and 5 in South America — 210 in total, with the Middle East and North Africa row left blank. Against $24,462,664 that is $116,488.88 each. We show it because it is a published headcount that does not reconcile to 330, not because we think it is the better denominator.",
      },
    ],
  },
  ministryClaims: [
  ...
  scores: {
    gospelCentrality: {
      value: 3,
      note: "Reformed, explicit and unusually specific: the first of Serge's stated values is the centrality of the gospel, and the audit's own description of the ministry names the gospel of grace as its motive and power. The discipleship material it sells — Sonship, the Gospel-Centered series — is doctrine a donor can read and check.",
    },
    localLeadership: {
      value: 1,
      note: 'A sending agency by design, and the numbers say so: Foreign National Wages are $239,826 of $17,693,531 in total wages, 1.4%. Nationals are funded through $1,618,179 of unnamed grants to foreign organisations. Scored on what is published, this is a 1 — though placing workers inside African-run mission hospitals is a better posture than the figure alone suggests.',
    },
    financialTransparency: {
      value: 3,
      note: "The best in this batch and close to the best we have seen. Serge posts both the audited statements and the full Form 990 for the same year, side by side, going back to 2008 — eighteen consecutive years — with Schedule F breaking foreign spending and headcount down by region. A donor can check almost every figure on this page in one place. The unexplained $64,366 difference between the two documents' expense totals keeps it from being a perfect 3, and it is the only thing that does.",
    },
    outcomeEvidence: {
      value: 1,
      note: 'Serge reports its own staff and the countries they are in, and that is all. No count of churches planted, patients seen, students taught or leaders trained is published, and the FY2025 annual report is posted as an Issuu flipbook that cannot be cited. Teams sit inside five named mission hospitals, so the delivery data exists somewhere.',
    },
    costEvidence: {
      value: 2,
      note: 'Numerator and denominator come from the same audited document for the same fiscal year, which is rare and good. Held at 2 because the denominator is a headcount of staff rather than a count of anything delivered, and because the public worker and country counts do not match the audited ones.',
    },
  },
  notVerified: [
  ...
  sources: [
    ...
    },
    {
      ...
      documentType: 'ministry-website',
      retrieved: '2026-09-19',
      note: 'Posts audited statements and Form 990s side by side for every year from 2008 to 2025. Source of the ECFA membership and the Charity Navigator claim. The page body says twelve consecutive years; the page metadata says eight.',
    },
    {
      id: 'serge-wws',
      ...
      documentType: 'ministry-website',
      retrieved: '2026-09-19',
      note: 'Source of the eighteen named team countries used in the country list on this page. The page carries the same headline sentence twice with two different country counts — 29 above the map, 26 above the list.',
    },
    {
      id: 'serge-audit-25',
      ...
      retrieved: '2026-09-19',
      fiscalYear: 'FYE May 2025',
      note: 'Source of both halves of the division: field operations expense of $24,462,664 and the footnote stating 330 missionaries in 25 countries. Also the source of Foreign National Wages, grants to foreign organisations and the net asset designations.',
    },
    {
      id: 'serge-990',
      ...
      retrieved: '2026-09-19',
      fiscalYear: 'FYE May 2025',
      note: "Source of the Schedule F regional table — expenditure and headcount for six regions — and of the $30,408,649 total functional expenses that does not match the audit's $30,344,283.",
    },
  ],
};
