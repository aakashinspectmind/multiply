...
export const epicChurchHopeProject: Cause = {
  ...
  biblicalAlignment: {
    ...
    scriptures: [
      ...
      },
      {
        ...
        text: 'For they gave according to their means, as I can testify, and beyond their means, of their own accord, begging us earnestly for the favor of taking part in the relief of the saints.',
      },
      {
        ref: 'Galatians 2:10',
        text: 'Only, they asked us to remember the poor.',
      },
    ],
    concerns: [
  ...
  scores: {
    gospelCentrality: {
      value: 3,
      note: 'A church offering directed at gospel work: church plants, discipleship networks and persecuted pastors sit alongside the mercy ministries.',
    },
    localLeadership: {
      value: 3,
      note: 'Every partner is a local organisation led by people in that place, and the church sends teams to serve with them rather than running the work itself.',
    },
    financialTransparency: {
      value: 1,
      note: 'The booklet names the partners and the $600,000 goal, and the page states more than $3 million given over 14 years. No split by partner, and no financial statement for the fund.',
    },
    outcomeEvidence: {
      value: 1,
      note: 'Narrative plus scattered counts — 400 children in after-school programs, 30,800 people reached through community outreach, 175 youth at Christmas, 50 girls in a dance ministry. Real, but not a reporting system.',
    },
    costEvidence: {
      value: 0,
  ...
  portfolio: [
    {
      ...
      place: 'Eswatini',
      work: 'Orphan and vulnerable children’s home; Epic funds a worship ministry camp for musically gifted children.',
    },
    {
      name: 'Vida Real',
      place: 'Guatemala',
      work: 'Nationwide work to accelerate the end of poverty in Guatemala.',
    },
    {
      name: 'Lighthouse Church',
      place: 'Vietnam',
      work: 'Launching the Thu Duc church plant — equipment, biblical education and leadership support.',
    },
    {
      name: 'The Pearl House',
      place: 'Ghana',
      work: 'Protects, educates and disciples at-risk young women; Epic gave toward launching Pearl College.',
    },
    {
      name: 'Mustard Seed Network',
      place: 'Japan',
      work: 'Church-planting network across 12 cities; Epic hosts its pastoral vision retreat.',
    },
    {
      name: 'God For Nations',
      place: 'North India',
      work: 'Reaching unreached peoples; Epic funded a retreat for pastors facing persecution and imprisonment.',
    },
    {
      name: 'International Justice Mission',
      place: 'Thailand',
      work: 'Identified and supported nearly 500 victims of forced labour in scam compounds in Southeast Asia.',
    },
    {
      name: 'Saint Church',
      place: 'East London, England',
      work: 'Leadership training using creativity and innovation.',
    },
    {
      name: 'Streams Studio',
      place: 'England',
      work: 'Video content aimed at people who have drifted from faith.',
    },
    {
      name: 'Neighbourhood Church',
      place: 'Perth, Australia',
      work: 'New church plant; Epic’s support started weekly services.',
    },
    {
      name: 'City Impact',
      place: 'San Francisco',
      work: 'Fourteen service programs in the inner city for over 30 years.',
    },
    {
      name: 'Bessie Carmichael School',
      place: 'San Francisco',
      work: 'SoMa’s only public school, nearly 700 students; Epic supports its teachers.',
    },
    {
      name: 'Foster the City',
      place: 'Bay Area',
      work: 'Coalition of churches recruiting homes for every child in foster care.',
    },
    {
      name: 'Open Door Legal',
      place: 'San Francisco',
      work: 'Universal access to legal help; prevented hundreds of evictions into homelessness.',
    },
    {
      name: 'A Woman’s Place',
      place: 'San Francisco',
      work: 'The city’s only 24-hour residential program for women in crisis.',
    },
    {
      name: 'Because Justice Matters',
      place: 'Tenderloin',
      work: 'Dance, mentorship and safe community for women and girls.',
    },
    {
      name: 'Mobilize Love',
      place: 'San Francisco',
      work: 'City-wide outreach; 400 children in after-school programs and 30,800 people reached in 2025.',
    },
    {
      name: 'United Playaz',
      place: 'San Francisco',
      work: 'Violence prevention and youth development, 25 years in the city.',
    },
    {
      name: 'Old Skool Cafe',
      place: 'San Francisco',
      work: 'Restaurant job training and paid work for at-risk youth.',
    },
    {
      name: 'TL Connect (YWAM)',
      place: 'Tenderloin',
      work: 'Weekly visits to neighbours living in single-room occupancies.',
    },
    {
      name: 'Rise Prep',
      place: 'San Francisco',
      work: 'Education for an underserved community.',
    },
    {
      name: 'Olive Us Restored',
      place: 'San Francisco',
      work: 'Teaching and resources for women; Epic sponsors the 2026 Restored Retreat.',
    },
    {
      name: 'Convoy of Hope',
      place: 'Global',
      work: 'Food manufacturing and packaging centre opening 2026 to increase meals produced.',
    },
  ],
