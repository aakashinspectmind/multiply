...
export const foodForTheHungry: Cause = {
  ...
  costModel: {
    ...
    count: {
      amount: 1754292,
      label:
        'people reached with life-saving assistance through emergency responses in 10 countries',
      fiscalYear: '2025',
    ...
    alternates: [
      {
        ...
        count: 10222078,
        note: 'Against all $131,268,099 of programme spending this works out at $12.84 a person. It is the ministry’s headline figure and it is the broad one: it counts anyone touched by any programme, including long-term development and child sponsorship, so it hides the difference between a person who received a week of emergency rations and a community that had a water committee trained. The narrow emergency figure is the honest one for a relief donor.',
      },
      {
        label: 'people with better access to clean water, sanitation and hygiene facilities',
        count: 1117833,
        note: 'Published in the same report and much closer to a durable physical outcome, but it spans emergency and development work and cannot be matched to a single spending line.',
      },
    ],
  },
  ministryClaims: [
  ...
  scores: {
    gospelCentrality: {
      value: 2,
      note: 'The audit describes FH as “a Christian international relief and development organization” and the about page says “We follow Jesus” and that staff “are motivated by their Christian faith”. But there is no statement of faith we could find, and the flagship impact report never names Christ. Identifiably Christian, not demonstrably gospel-centred in its own reporting.',
    },
    localLeadership: {
      value: 3,
      note: 'The strongest local-staffing figure in this batch: 99% of staff in their country of origin, with the impact report naming eleven country offices by their own index scores. Held at 3 rather than qualified downward because the claim is specific, published, and consistent with a structure of country offices rather than expatriate field teams.',
    },
    financialTransparency: {
      value: 3,
      note: 'Audited consolidated statements, Form 990s and annual reports going back more than a decade are posted on the ministry’s own financial page, functional expenses are split three ways by programme line, and the audit discloses its revenue concentration and its gift-in-kind valuation basis in plain language. The two-year losses are visible in the same document, which is how it should be.',
    },
    outcomeEvidence: {
      value: 2,
      note: 'Counts are published, they are specific, and — unusually — they are broken into a broad figure and a narrow emergency figure rather than collapsed into one. Marked down because no unit is defined: nothing says what “reached” means, whether people are de-duplicated across programmes, or who checked the numbers.',
    },
    costEvidence: {
      value: 2,
      note: 'Both halves exist, one from an audit and one from a published report, and the programme line is specific enough that the division is not purely notional. Marked down for the period overlap and because Food for the Hungry publishes no cost per outcome of its own for ours to be checked against.',
    },
  },
  notVerified: [
  ...
  sources: [
    {
      ...
      note: 'Source of “We follow Jesus”, the description of FH as “a Christian relief and development organization”, and the “18 countries” figure that disagrees with the impact report.',
    },
    {
      id: 'fh-financials',
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      fiscalYear: 'FY2025',
      note: 'Source of every financial figure here, including the functional expense table by programme line, the revenue concentration note and the gift-in-kind valuation basis.',
    },
    {
      id: 'fh-impact-25',
      ...
      retrieved: '2026-09-18',
      fiscalYear: '2025',
      note: 'Source of all outcome counts. The headline numbers are set as large graphics beside their captions, so we matched each figure to its own caption by reading the page layout.',
    },
    {
      id: 'fh-990-24',
