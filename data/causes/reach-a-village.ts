...
export const reachAVillage: Cause = {
  ...
  accreditations: [
    { label: 'ECFA accredited (ministry\'s own statement)', sourceId: 'rav-ar25' },
    { label: 'Charity Navigator 4 stars (ministry\'s own statement)', sourceId: 'rav-ar25' },
  ],
    ...
    alternates: [
      {
        ...
        count: 4236,
        note:
          'The remaining 713 are counted under children\'s outreach. Using only the adult programme line gives $530.66 per church, and is the closer match to what a donor giving to church planting probably pictures.',
      },
      {
        label: 'foreign grants only, divided by all churches started',
        count: 4949,
        note:
          'Charging only the $1,861,639 that Schedule F shows leaving the United States gives $376.16 per church started and excludes every dollar of US-side programme cost.',
      },
    ],
  },
  ministryClaims: [
  ...
  scores: {
    gospelCentrality: {
      value: 3,
      note:
        'A mission and faith statement on the site, and the mission statement names Jesus Christ and His Church directly. The programme is church planting, Scripture distribution and discipleship training with nothing else in it.',
    },
    localLeadership: {
      value: 3,
      note:
        'Schedule F reports no office and no employee, agent or contractor in any foreign region; all nine employees are in the United States. The work is done by local church leaders receiving grants.',
    },
    financialTransparency: {
      value: 1,
      note:
        'Form 990s are posted for several years and are detailed, including a region-by-region Schedule F. But no audited statements are published despite the return referring to them, and three different expense totals for the same year appear across their own documents without explanation.',
    },
    outcomeEvidence: {
      value: 1,
      note:
        'Counts are published annually, broken into adult and children\'s programmes, and the two church figures add exactly to the headline. Nothing else supports them: no definition of a church, no attrition figure, no external check, and the ministry is currently building the field data-collection app it says will let partners track results in real time — which suggests the present counts are collected less systematically than the published totals imply.',
    },
    costEvidence: {
      value: 2,
      note:
        'Both halves exist for the same fiscal year and the numerator comes from Part IX of the return rather than from marketing. Held at 2 because the spending total itself is reported three different ways and the audited statements behind it are not published.',
    },
  },
  notVerified: [
  ...
  sources: [
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      note:
        'The index page for Form 990s and annual reports. No audited or reviewed financial statements appear on it. A /financials path does not exist on this site.',
    },
    {
      id: 'rav-990-24',
    ...
    },
    {
      ...
      fiscalYear: 'FY2025 (1 Sep 2024 – 31 Aug 2025)',
      note:
        'Source of the 4,949 churches started, the 4,236 / 713 split, the funding-source and expense percentages and the accreditation claims. The headline counts and the funding chart are set as graphics; figures were read off the rendered pages rather than from extracted text alone.',
    },
    {
      id: 'rav-propublica',
