...
export const greaterEuropeMission: Cause = {
  ...
  scores: {
    ...
    costEvidence: {
      value: 0,
      note:
        'The numerator is audited, precise and current. There is nothing at all to divide it by, so the arithmetic this site exists to do cannot be done here. That is a 0, and it is a finding about GEM rather than about our research.',
    },
  },
  notVerified: [
  ...
  sources: [
    ...
    },
    {
      ...
      retrieved: '2026-09-19',
      note:
        'GEM\'s own case for spending mission money in high-income countries, including the 2.9% figure it attributes to the Joshua Project.',
    },
    {
      id: 'gem-nations',
      label: 'Nations',
      ...
      retrieved: '2026-09-19',
      note:
        'Source of the 26 nations listed on this page. No nation page carries a worker count, a church count or a budget.',
    },
    {
      id: 'gem-give',
      label: 'Give',
    ...
    },
    {
      ...
      note:
        'Source of every audited figure on this page: the functional expense table, the national-ministries note, the Greek Bible Institute transfer, the GEMi related-party disclosure, the $7,977,716 restricted for Missionary support and the unfunded $391,453 deferred compensation obligation. It contains no count of workers.',
    },
    {
      id: 'gem-ecfa',
      ...
      retrieved: '2026-09-19',
      note:
        'Confirms accreditation and the member-since date, and restates GEM\'s own financial totals. Like everything else about GEM, it carries no worker count.',
    },
    {
      id: 'gem-propublica',
      ...
      retrieved: '2026-09-19',
      note:
        'Source of the EIN and of the officer compensation figure. Structured filing data covers the years ended June 2022 and June 2023 only, so it is two years behind the audit, and GEM does not link its Form 990 from its own site.',
    },
  ],
};
