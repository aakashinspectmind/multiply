...
export const seedEffect: Cause = {
  ...
  scores: {
    gospelCentrality: {
      value: 3,
      note:
        'Spiritual discipleship is inside the mission statement, the core beliefs say introducing people to Jesus is essential rather than incidental, and delivery runs through partnership with local churches. There is no ambiguity here — the only question a reader should weigh is the one in our concerns, about what it means to offer discipleship and savings from the same hand.',
    },
    localLeadership: {
      value: 2,
      note:
        '115 staff in 2025, overwhelmingly in northern Uganda and South Sudan, delivering through local churches, and the chief executive writes of work "led by the very communities we serve". Marked at 2 rather than 3 because governance, the board and fundraising are in Dallas and Seed Effect publishes no breakdown of national versus expatriate leadership.',
    },
    financialTransparency: {
      value: 2,
      note:
        'An unusually complete run of documents: annual reports for every year from 2014 to 2025, financial statements for the same span, a Form 990, and an explicit disclosure that the fiscal year moved from January to July in 2024 with a short-year audit covering the gap. Held at 2 because the current audit is a scanned image we could not read, so we took the expense figures from the annual report\'s summary page instead.',
    },
    outcomeEvidence: {
      value: 1,
      note:
        'The only counts published are lifetime, explicitly footnoted as such, so nothing can be tied to a year. The business-training results — 37% started a business, 86% still trading at six months — are the most specific outcome figures in this batch and are entirely self-reported with no sample size, no response rate and a six-month horizon.',
    },
    costEvidence: {
      value: 1,
      note:
        'A unit price is advertised, $90 per person for three years, with no published denominator to check it against. Audited spending exists; an annual member count does not. There is a price but no arithmetic.',
    },
  },
  notVerified: [
  ...
  sources: [
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      note:
        'The mission statement, the vision and all four core beliefs are on this single page. The separate /core-beliefs and /our-vision paths linked in the navigation return 404.',
    },
    {
      id: 'se-impact',
      label: 'Our Impact',
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      note:
        'Annual reports and financial statements for every year from 2014 to 2025, a Form 990, and the disclosure that the fiscal year moved from a 1 January to a 1 July start in July 2024 with a short-year audit covering January to June 2024.',
    },
    {
      id: 'se-ar-25',
      ...
      fiscalYear: '2025',
      note:
        'Source of every figure used here, including the expense breakdown on its financial summary page (program services $1,592,760, general and administration $486,249, fundraising $191,557, total $2,270,566), the 123,630 lifetime members with the branch-level footnote, the member savings and lending totals, the business-training results, the staff count and the $90 and $2,250 gift prices. Several figures sit in a designed layout and were reassembled from text extracted out of interleaved columns.',
    },
    {
      id: 'se-audit-25',
      ...
      fiscalYear: '2025',
      note:
        'Cited for completeness, not relied on: the file is a scanned image with no text layer, so nothing in it could be read or checked. The expense figures on this page come from the annual report instead.',
    },
    {
      id: 'se-propublica',
