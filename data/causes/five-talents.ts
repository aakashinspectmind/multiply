...
export const fiveTalents: Cause = {
    ...
    scriptures: [
      {
        ...
        text:
          'And he who had received the five talents came forward, bringing five talents more, saying, "Master, you delivered to me five talents; here, I have made five talents more." His master said to him, "Well done, good and faithful servant."',
      },
      {
    ...
    alternates: [
      {
        ...
        count: 331594,
        note:
          'Dividing one year of spending by 27 years of members would be meaningless, and it is shown here only because it is the number the ministry leads with. Cumulative counts also double-count anyone who was in a group for more than one year.',
      },
    ],
  },
  ministryClaims: [
  ...
  scores: {
    gospelCentrality: {
      value: 2,
      note:
        'Self-describes as a Christian organisation and works through Anglican dioceses and local churches, which is a real ecclesial channel rather than a branding choice. But there is no statement of faith, no doctrinal position, and the programme materials are about savings, business and governance. Christ is not named in the model description.',
    },
    localLeadership: {
      value: 3,
      note:
        'Field programmes are run by national staff and by the dioceses themselves, and Kenya has its own incorporated Five Talents entity. Governance and the largest share of fundraising remain in the United States and the United Kingdom, but there is no expatriate delivery layer in the model.',
    },
    financialTransparency: {
      value: 2,
      note:
        'Audited statements, Form 990s and annual reports are all posted, which is more than most ministries this size. Marked down for two things: the audit covers only the US entity while the impact counts are global, and the annual report\'s functional expenses ($1,382,261 program, $1,837,524 total) do not match the audit\'s ($1,382,618 and $1,844,350).',
    },
    outcomeEvidence: {
      value: 2,
      note:
        'Members served and total member savings are published annually, and Five Talents went further than almost anyone in this category by commissioning a longitudinal study in Burundi with real before-and-after figures. The study has no control group and relies on participant recall, so it cannot separate the programme from everything else happening in Burundi, and no comparable study exists for the other nine countries.',
    },
    costEvidence: {
      value: 2,
      note:
        'Both halves are published and both are sourced, but they do not cover the same organisation — audited US spending against worldwide members — so the quotient is a floor rather than a cost.',
    },
  },
  notVerified: [
  ...
  sources: [
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      note:
        'The only accountability page on the site — /financials and /about both 404. Everything is linked from here: audited statements, Form 990s, annual reports, the Burundi study, the repayment claims and the $30-$50 loan figure.',
    },
    {
      id: 'ft-audit-25',
      ...
      fiscalYear: '2025',
      note:
        'Program services $1,382,618, management and general $182,110, fundraising $274,595, total $1,844,350. Covers the US entity only; the UK and Kenya organisations are not consolidated.',
    },
    {
      id: 'ft-ar-25',
      ...
      fiscalYear: '2025',
      note:
        'Source of the 59,253 members served in 2025, the 331,594 cumulative figure, the $2.5 million in member savings and the $4,338,794 combined income across the three Five Talents entities. Its functional expense figures differ slightly from the audit.',
    },
    {
      id: 'ft-burundi',
      ...
      fiscalYear: '2023',
      note:
        'A 573-participant retrospective survey of savings group members, commissioned by Five Talents. No control group. Commissioned research rather than independent evaluation, but the closest thing to an outcome study in this category.',
    },
  ],
};
