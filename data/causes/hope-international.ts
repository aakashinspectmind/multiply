...
export const hopeInternational: Cause = {
  ...
  accreditations: [
    ...
    { label: 'Charity Navigator four-star rating, 17 consecutive years', sourceId: 'hope-financials' },
  ],
    ...
    alternates: [
      {
        ...
        count: 173551,
        note:
          'HOPE footnotes this number "*HOPE-led programs only," so it excludes members reached through network partners. Against all program spending it is the wrong pairing — most of that spending is microfinance — but it is the count that matches the cheap half of the model.',
      },
      {
        label: 'new microfinance clients only',
        count: 99658,
        note:
          'Loans disbursed, not businesses that survived. HOPE publishes $148M disbursed against this figure and no follow-up on what happened to the borrowers.',
      },
    ],
  },
  ministryClaims: [
  ...
  sources: [
    ...
    },
    {
      ...
      retrieved: '2026-09-18',
      note:
        'Source of the mission statement and the "group of Christ followers" identity paragraph. Note that /about-us/what-we-believe, /about-us/guiding-statements and other invented paths all serve this same page with a 200, so the absence of a statement of faith is easy to miss.',
    },
    {
      id: 'hope-financials',
      ...
      retrieved: '2026-09-18',
      note:
        'Displays ECFA accreditation and the 17-year Charity Navigator four-star record, and links the audited statements, annual reports and Form 990s.',
    },
    {
      id: 'hope-audit-25',
    ...
    },
    {
      ...
      fiscalYear: '2025',
      note:
        'Source of every outcome count used here: 173,551 new savings group members, 2,114 new local churches equipped, $56.55 average savings per member, 99,658 new microfinance clients, $148M disbursed and the 97.1% repayment rate. The report states its financial figures are unaudited, and they differ from the audit.',
    },
    {
      id: 'hope-propublica',
