...
export const thirdmill: Cause = {
  ...
  costModel: {
    outcome: 'student enrolled in the Thirdmill Institute',
    outcomePlural: 'students enrolled in the Thirdmill Institute',
    spend: {
      amount: 12115451,
      basis: 'total-expenses',
      fiscalYear: 'two years to June 2023',
    ...
    caveat:
      'We do not divide by the number Thirdmill leads with. Its headline is 172,265 reported students added in a year, which against one year of spending would read $37.73 — but a "reported student" is somebody a partner organisation told Thirdmill was using the curriculum, an access count rather than a trained pastor, and the same bucket holds a person in an eighteen-month three-certificate cohort and a person who watched one lesson on YouTube. The Institute is the only pathway where a student is enrolled, supervised by a local leader and working toward a named certificate, so it is the denominator here. Both halves cover the same window, the Institute’s first two years: $5,615,717 in the year to June 2022 plus $6,499,734 in the year to June 2023, against the 9,034 students the 2022-2023 report says the Institute had served. It is a hard upper bound in two ways. Every dollar Thirdmill spent in those two years is charged to the Institute, including the curriculum production, the translation into 28 languages, all five distribution channels, fundraising and administration — and that curriculum, once written, keeps teaching for years at nearly no further cost. Read it as the ceiling of a range whose floor is $37.73, and note that the range is that wide because Thirdmill does not know, in any checkable way, how many people are being trained with its material.',
    alternates: [
      {
        label: 'reported students added across all distribution channels in one year (172,265)',
        count: 172265,
        note: 'About $37.73 against a single year of spending, and the figure the ministry leads with. Undefined, partner-reported, possibly double-counted across channels — the floor of the range rather than a price.',
      },
      {
        label: 'certificates and diplomas the Thirdmill Institute had awarded in total',
        count: 429,
        note: 'The strictest denominator: 347 Foundations, 62 Biblical Studies and 20 Theological Studies certificates, plus 20 complete Diplomas in Christian Ministry. Cumulative since the Institute began over a window Thirdmill does not state, and a certificate is one of three stages rather than a finished qualification, which is why it is not the primary figure.',
      },
    ],
  },
  ministryClaims: [
  ...
  notes: [
    'This was the cheapest-looking number in the directory and also the weakest, and that is why it is no longer the number on the page. $37.73 per newly reported student is arithmetically correct and close to meaningless as a price for a trained pastor, so the figure shown is built on the Institute instead and the $37.73 sits below it as the floor of a range reaching past $15,000. The honest reading is that Thirdmill produces curriculum very cheaply and does not know, in any checkable way, how many people are being trained with it.',
