...
export const harvestBridge: Cause = {
  ...
  biblicalAlignment: {
    ...
    doctrine: {
      label: "Statement of Faith (Apostles' Creed)",
      sourceId: 'hb-faith',
    },
    concerns: [
    ...
    alternates: [
      {
        ...
        count: 253,
        note: 'The same $317,960 line gives $1,256.76 per supported missionary-year. Both this and the church figure are true of the same money, which is why neither should be read as the price of one thing.',
      },
      {
        label: 'churches planted charged against all grants made',
        count: 274,
        note: 'Charging the whole $728,171 of grants to the church count gives $2,657.56, the honest upper bound if you believe the relief and development work exists to open the door for the church planting.',
      },
    ],
  },
  ministryClaims: [
    ...
    {
      quote: 'Harvest Bridge shares the nonsectarian beliefs articulated in the Apostles’ Creed:',
      sourceId: 'hb-faith',
    },
  ],
  scores: {
    ...
    outcomeEvidence: {
      value: 1,
      note: 'Counts are published for the same year as the audit, in a filed federal return, which is worth something. Against that: every figure comes from the grantee, no definition of a church or a fellowship is given, the relief count appears twice with two different values, and no external party has checked anything.',
    },
    costEvidence: {
      value: 3,
      note: 'The rarest combination in this category — an audited grant line for church planting specifically, and a count for the same calendar year in a filed return. The division needs no estimate on either side. Harvest Bridge publishes no cost per church itself.',
    },
  },
  notVerified: [
